...
function buildBlueprintData(inputs = getInputs()) {
  const seed = inputs.comfort.length + inputs.progression.length + inputs.trope.length + inputs.warmth;
...
function ensureBriefRecord(record) {
  ...
  const generated = buildBlueprintData(record.inputs);
  return {
    ...generated,
    ...record,
